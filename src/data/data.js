...
export const YogaVariation = [
  {
    ...
    image:
      "https://images.squarespace-cdn.com/content/v1/5f35301faed3a85bf80f77ed/1600440219305-RZTH2MR2SAW2HWNGMUNG/img_news1.jpg",
  },
  {
    id: 2,
    title: "Trikonasana",
    ...
    image:
      "https://images.pexels.com/photos/5384538/pexels-photo-5384538.jpeg?auto=compress&cs=tinysrgb&w=600",
  },
  {
    id: 3,
    ...
    description:
      "Adho Mukha Svanasana is a yoga asana that is commonly translated as Downward-Facing Dog Pose.",
    image: "https://www.yogateket.com/image/original/downwardfacingdog.jpg",
  },
];
...
export const WorkoutVariation = [
  ...
  },
  {
    ...
    route: "/crunches",
    description:
      "A crunch is a abdominal exercise in a strength-training program. It targets the rectus abdominis muscle.",
    image:
  ...
  },
  {
    ...
    route: "/bicepcurls",
    description:
      "A biceps curl is an exercise used in weight training and bodybuilding in which the trainee performs a curling motion with a dumbbell or barbell while standing up.",
    image:
